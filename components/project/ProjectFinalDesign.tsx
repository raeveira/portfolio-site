...
export default function ProjectFinalDesign({Project}: { Project: ItemIdentifier }) {
    ...
    return (
        <section id={projectItems.SidebarItems[9].id}
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <MarkDot/>
                            <div
                                className={'leading-[19px] font-medium text-[11px] NeueMontreal mt-[1px] tracking-[1.5px] text-left text-[#f2f2f226] 1920px:leading-[18px] 1920px:text-[14px] 1920px:tracking-[2px] max-479px:leading-[16px] max-479px:text-[10px] '}>FINAL DESIGNS
                            </div>
                        </div>
                        <div
                            ...
                            {projectItems.Content.finalDesign.heading}
                        </div>
                    </div>
                    {/* Section content block */}
                    {projectItems.Content.finalDesign.information.map((value, index) => (
                        <React.Fragment key={index}>
                            ...
                            <DynamicImages images={value.image} number={"3"} points={value.points} additionalPoints={value.additionalPoints} additionalPoints1={value.additionalPoints1} additionalPoints2={value.additionalPoints2}></DynamicImages>
                        </React.Fragment>
                    ))}
                </div>
            </div>
