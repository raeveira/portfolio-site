...
export default function ProjectVisualDesign({Project}: { Project: Project }) {
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <MarkDot/>
                            <div
                                className={'leading-[19px] font-medium text-[11px] NeueMontreal mt-[1px] tracking-[1.5px] text-left text-[#f2f2f226] 1920px:leading-[18px] 1920px:text-[14px] 1920px:tracking-[2px] max-479px:leading-[16px] max-479px:text-[10px] '}>VISUAL DESIGN DIRECTION
                            </div>
                        </div>
                        <div
