                                ...
                                <div className={'w-full mb-[12px] 1920px:mb-[16px]'}>
                                    <div className={'flex items-center justify-end'}>
                                        <div
                                            ...
                                            <Label htmlFor="interactiveMode" className={'leading-[100%] font-medium text-[16px] NeueMontreal tracking-[.2px] 1920px:text-[18px] max-767px:text-[15px]'}>{!isInteractive ? 'Show' : 'Hide'} {image.interactText}</Label>
                    ...
                    {index === 0 && points && points.length > 0 && (
                        <div className={'flex flex-col space-y-12 max-767px:pt-0 max-991px:pb-10'}>
                            <div className={'flex flex-col space-y-1'}>
                                {points.map((item, i) => {
                                    const position = i === 0 ? 'top' : i === points.length - 1 ? 'bottom' : 'middle';
                                    return (
                        ...
                        <div className={'flex flex-col space-y-12 max-767px:pt-0'}>
                            <div className={'flex flex-col space-y-1'}>
                                {additionalPoints.map((item, i) => {
                                    const position = i === 0 ? 'top' : i === additionalPoints.length - 1 ? 'bottom' : 'middle';
                                    return (
                                        <ContainedPointsItem key={i} position={position} imageSrc={item.icon}>
                                            <>
                                                <HighlightedBody content={item.highlightedText}/>
