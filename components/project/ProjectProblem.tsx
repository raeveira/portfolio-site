    ...
    return (
        <section id={projectItems.SidebarItems[4].id}
            ...
            <div
                    ...
                    <div
                        ...
                        <div className={'flex flex-col gap-y-[48px] 1920px:gap-y-[64px] max-767px:pt-0'}>
                            ...
                            <div className="flex flex-col gap-y-[4px]">
                                {projectItems.Content.problem?.points.map((item, index, array) => {
                                    let position;
                                    if (index === 0) position = 'top';
                                    else if (index === array.length - 1) position = 'bottom';
                ...
                <DynamicImages images={projectItems.Content.problem?.images || null} number={'2'} points={undefined} additionalPoints={undefined} additionalPoints1={undefined} additionalPoints2={undefined} />
            </div>
        </section>
    )
}