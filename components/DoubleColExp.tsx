const DoubleColExp = ({title, subheader, date, content}: {title: string, subheader: string, date: string, content: string}) => {
    return (
        <div className={'grid items-baseline self-stretch justify-between auto-cols-[1fr] grid-cols-[1fr_1fr] grid-rows-[auto] gap-y-[16px] gap-x-[48px] 1920px:gap-x-[72px] 1440px:gap-x-[56px] max-991px:gap-x-[32px] max-767px:gap-y-[16px] max-767px:grid-cols-[1fr] max-767:grid-rows-[auto_auto]'}>
            {/* title */}
            ...
            <div className={'flex flex-col gap-y-[48px] pt-0 1920px:gap-y-[64px] max-767px:pt-0'}>
                <div className={'flex flex-col gap-y-[20px] 1440px:gap-y-[24px] max-767px:gap-y-[16px]'}>
                    <div className={'flex flex-col gap-y-[8px] 1920px:gap-y-[10px] max-991px:gap-y-[12px] max-767px:gap-y-[4px]'}>
                        ...
                        <div className={'leading-[125%] font-normal text-[16px] NeueMontreal text-[#f2f2f266] 1920px:text-[20px] 1440px:text-[10px] max-479px:leading-[19px] max-479px:text-[15px]'}>{date}</div>
                    </div>
